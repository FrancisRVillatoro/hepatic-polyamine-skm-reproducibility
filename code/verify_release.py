...
expected = [
    'code/BIOMD0000000190_url.xml',
    'code/BIOMD0000000674_url.xml',
    'code/BIOMD0000000450_url.xml',
    'requirements-lock.txt', '.zenodo.json', 'CITATION.cff',
    'V1_0_1_ADDITIONS_MANIFEST.tsv', 'SHA256SUMS_v1.0.1.txt',
    'code/compatibility_spectral_projection.py',
    'code/cusp_nondegeneracy_check.py',
    'code/mu_inf_precision_audit.py',
    'code/native_meal_cycle_control.py',
    'code/reproduce_v10_2_audits.py',
...
if version != '1.0.1':
    print('ERROR: VERSION is', version, 'expected 1.0.1')
    sys.exit(1)
...
for line in (ROOT / 'SHA256SUMS_v1.0.1.txt').read_text(encoding='utf-8').splitlines():
    ...
    checks[name.strip().removeprefix('./')] = h
errors = []
